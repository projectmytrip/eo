...
@Entity
@Table(name = "KPI_OIL")
public class KpiOil implements Comparable<KpiOil> {
	...
	public KpiOil(String id, String descrizione, String tooltipMsg, String tipoKpi, String freqRegistrazione,
