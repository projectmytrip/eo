...
@Entity
@Table(name = "KPI_NETWORK")
public class KpiNetwork implements Comparable<KpiNetwork> {
	...
	public KpiNetwork(String id, String descrizione, String tooltipMsg, String tipoKpi, String freqRegistrazione,
	...
	@Override
	public int compareTo(KpiNetwork o) {
