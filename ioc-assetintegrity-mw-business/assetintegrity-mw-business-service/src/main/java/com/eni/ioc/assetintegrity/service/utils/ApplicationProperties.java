...
public class ApplicationProperties {
	...
	private static String publicKeyJwt;
	...
	public String getPublicKeyJwt() {
		return publicKeyJwt;
	}

	@Value("${publicKey.jwt}")
	public void setPublicKeyJwt(String publicKeyJwt) {
		ApplicationProperties.publicKeyJwt = publicKeyJwt;
	}
