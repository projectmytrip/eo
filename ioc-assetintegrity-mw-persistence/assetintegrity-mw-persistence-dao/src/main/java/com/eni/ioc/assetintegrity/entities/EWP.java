...
public class EWP {
	...
	public String toString() {
		return "EWP [numeroEWP=" + numeroEWP + ", status=" + status + ", descrizioneLavoro=" + descrizioneLavoro
				+ ", appaltatore=" + appaltatore + ", impresaEsecutrice=" + impresaEsecutrice + ", prepostoAiLavori="
				+ prepostoAiLavori + ", richiedente=" + richiedente + ", unitaRichiedente=" + unitaRichiedente
				+ ", sorvegliante=" + sorvegliante + ", autorizzanteAnalisiDiRischio=" + autorizzanteAnalisiDiRischio
				+ ", unitaAutorizzante=" + unitaAutorizzante + ", dataChiusura=" + dataChiusura
				+ ", dataOraInizioAutorizzazione=" + dataOraInizioAutorizzazione + ", dataOraScadenzaAutorizzazione="
				+ dataOraScadenzaAutorizzazione + ", indicazioneTipologiaAttivita=" + indicazioneTipologiaAttivita
				+ ", indicazioneSCE=" + indicazioneSCE + ", descrizioneSCE=" + descrizioneSCE + ", sedeTecnica="
				+ sedeTecnica + ", dataApertura=" + dataApertura + ", dataScadenza=" + dataScadenza + ", sottoArea="
				+ sottoArea + ", insertionDate=" + insertionDate + ", asset=" + asset + ", tags=" + tags + "]";
	}
