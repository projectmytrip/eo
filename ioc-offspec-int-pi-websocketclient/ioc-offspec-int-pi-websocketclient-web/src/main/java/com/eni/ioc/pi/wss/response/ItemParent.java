...
public class ItemParent {
     ...
     */
    public ItemParent(String webId, String name, String path, Links links, List<Item> items, String unitsAbbreviation) {
        super();
        this.webId = webId;
        this.name = name;
        this.path = path;
    ...
    public ItemParent withItems(List<Item> items) {
        this.items = items;
        return this;
    }
